...
static void assert_lamps(int red, int yellow, int green) {
    TEST_ASSERT_EQUAL_INT(red, mock_gpio_get(PICOKIT_16_IR_KEYS_RED_LED_PIN));
    TEST_ASSERT_EQUAL_INT(yellow,
                          mock_gpio_get(PICOKIT_16_IR_KEYS_YELLOW_LED_PIN));
    TEST_ASSERT_EQUAL_INT(green,
                          mock_gpio_get(PICOKIT_16_IR_KEYS_GREEN_LED_PIN));
}
...
static void test_status_led_init(void) {
    ...
    TEST_ASSERT_TRUE(s_mock_gpio_dirs[PICOKIT_16_IR_KEYS_RED_LED_PIN]);
    TEST_ASSERT_TRUE(s_mock_gpio_dirs[PICOKIT_16_IR_KEYS_YELLOW_LED_PIN]);
    TEST_ASSERT_TRUE(s_mock_gpio_dirs[PICOKIT_16_IR_KEYS_GREEN_LED_PIN]);
}
 ...
 */
static const uint8_t s_env_pt[] = "{\"n\":16,\"s\":0,\"k\":69}";
 ...
 */
static const char s_env_known_hex[] = "000102030405060708090a0b0c0d0e0f1011121314151617e5e0615daae3bb82113704f4fb7e8a83697d1e9c80686cc39f5e58a43985ded54e365f3627";
